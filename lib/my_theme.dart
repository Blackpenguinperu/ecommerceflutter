...
class MyTheme{
  ...
  static Color accent_color = Color.fromRGBO(54,84,134, 1);
  static Color soft_accent_color = Color.fromRGBO(78,49,29, 1);
  static Color splash_screen_color = Color.fromRGBO(54,84,134, 1); // if not sure , use the same color as accent color
